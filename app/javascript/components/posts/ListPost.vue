<template>
  <li class="list-post">
    <div class="list-post-author">
      <a href="#" class="pull-right" v-if="global.userCanEdit" @click.prevent="destroy" :disabled="deleting"><i class="fa fa-trash"></i></a>
    ...
    <div class="list-post-content">
      <a href="#" class="pull-right" v-if="global.userCanEdit && ! edit" @click.prevent="edit = true"><i class="fa fa-pencil"></i></a>
      <div v-if="edit">
